...
$subcategorias = $conexao->executarQuery("select * from subcategorias");


			if(isset($_POST['novasubcategoria']))
			{
				$conexao->executar("insert into subcategorias(subcategoria,idCategoria) values('".$_POST['subcategoria']."',".$_POST['idcategoria'].")");
