...
public class calculadora extends javax.swing.JFrame implements KeyListener {
 ...
 jTextField1.setText(jTextField1.getText()+"2");        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        switch(tipo_op)
        {
            case 1:jTextField1.setText(""+(m1 + Double.parseDouble(jTextField1.getText())));break;
            
            case 2:jTextField1.setText(""+(m1 - Double.parseDouble(jTextField1.getText())));break;
            
            case 3:jTextField1.setText(""+(m1 * Double.parseDouble(jTextField1.getText())));break;
            
            case 4: jTextField1.setText(""+(m1 / Double.parseDouble(jTextField1.getText())));break;
        }
    ...
    public void keyTyped(KeyEvent arg0) {
     tecla = String.format(KeyEvent.getKeyText(arg0.getKeyCode()));
     jTextField1.setText(tecla);
    }
